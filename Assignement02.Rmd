...
The null hypothesis that the difference is zero is rejected for all of the cases except for OJ2.0 - OJ1.0, which means that over a dose of 1 the difference in tooth growth when the dose is increased is not statistically significant.
...
Let's see in detail by different doses.
