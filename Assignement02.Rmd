...
The null hypothesis that the difference is zero is rejected for all of the cases, meaning that there is a statistically significant correletion between the dose and the tooth growth.
